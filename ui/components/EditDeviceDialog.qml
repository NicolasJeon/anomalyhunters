...
// 장비 정보 수정 모달 — anchors.fill: parent + z: 100 으로 사용
Rectangle {
    id: root
    ...
    signal deviceUpdated(string deviceId, string name, string type, string imageSource)

    visible: false
    color: "#a0000000"

    function open(id, name, type, img) {
        deviceId        = id
        nameInput.text  = name
        typeInput.text  = type
        imageSource     = img
    ...
    Rectangle {
        ...
        ColumnLayout {
            ...
            Text { text: "장비 정보 수정"; color: "#c0c0e0"; font.pixelSize: 16; font.bold: true }
            ...
            ColumnLayout {
                ...
                RowLayout {
                    ...
                    Rectangle {
                        ...
                        border.color: "#2a2c4e"
                        Text { anchors.centerIn: parent; text: "찾기"; color: "#88aaff"; font.pixelSize: 11 }
                        MouseArea {
                            id: browseMouse
                    ...
                    Rectangle {
                        ...
                        visible: root.imageSource !== ""
                        color: clearMouse.containsMouse ? "#3a1a1a" : "#1e1a1a"
                        border.color: "#3a2a2a"
                        Text { anchors.centerIn: parent; text: "제거"; color: "#cc6666"; font.pixelSize: 11 }
                        MouseArea {
                            id: clearMouse
                            anchors.fill: parent; hoverEnabled: true
                            onClicked: root.imageSource = ""
                        }
                    }
                }
            ...
            RowLayout {
                ...
                Rectangle {
                    ...
                    Text {
                        anchors.centerIn: parent; text: "저장"; font.pixelSize: 12
                    ...
                    MouseArea {
                        ...
                        onClicked: {
                            ...
                            if (name === "") return
                            root.deviceUpdated(root.deviceId, name,
                                               typeInput.text.trim() || "Generic",
                                               root.imageSource)
                            root.close()
                        }
                    }
